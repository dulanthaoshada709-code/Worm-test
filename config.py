...
BOT_TOKEN = "8517345479:AAG3_AQlemmKUXkKloWJxhhEZCwM9Nwa5n0"

ADMIN_CHAT_ID = 6812716511

# Channels to join

REQUIRED_CHANNELS = [

    {"name": "Aura TM", "url": "https://t.me/dmdhutto", "chat_id": "@dulanthawormai_bot"},

]

# Developer info
DEVELOPER_USERNAME = "@dulanthawormai_bot"

# Welcome message

WELCOME_MESSAGE = "🎉 Welcome to DULANTHA XRD WORM AI 🎉\n\nYour advanced AI assistant is ready to help you!"
